...
int main(int argc, char** argv){
	...
	cgui_button_on_click(add_button, add_button_callback);

    cgui_on_event(input_callback);
	...
	for (int i = 0; i < (int)things_size; i++){
		...
		cgui_button_on_click(things[i]->cell_button, status_button_callback);
	}
...
void add_button_callback(cgui_cell*){
	...
	cgui_button_on_click(new_thing->cell_button, status_button_callback);
